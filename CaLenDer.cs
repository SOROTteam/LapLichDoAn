...
namespace LapLichDoAn
{
    ...
    public partial class CaLenDer : Form
    {
        ...
        void SetDefaultJob()
        {
            ...
            Job.Job.Add(new PlanItem() { Date = DateTime.Now,
        ...
        void LoadMatrix()
        {
            ...
            Button oldBtn = new Button() { Width=0, Height = 0, Location = new Point(0-Cons.margin, 0) };
            for(int i=0;i<Cons.DayOfColumn;i++)
            {
                ...
                oldBtn = new Button() { Width = 0, Height = 0, Location = new Point(0-Cons.margin, oldBtn.Location.Y + Cons.dateButtonHeight) };
            }
